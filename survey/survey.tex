...
\usepackage[english,austrian, american]{babel}
...
\end{center}
This survey serves the purpose of granting an overview of and comparing the 
major online tools that help in the process of creating and analysing card 
sorting studies. We covered not only tools that help in creating an online card 
sorting study but also tools that only focus on analysing the results of card 
sorting studies. All in all a total of 8 tools were reviewed and assessed by a 
number of different metrics such as ease of use and the number of features 
provided. Finally, we will give our recommendations as to which tools turned 
out to be the most useful to us.
\end{quote}
...
\cleardoublepage
\input{survey-Optimal-Sort}

\cleardoublepage
\input{survey-xSort}

\cleardoublepage
\input{survey-UxTweak}

\cleardoublepage
\input{survey-ProvenByUsers}

\cleardoublepage
\input{survey-kardSort}

\cleardoublepage
\input{survey-SynCaps}

\cleardoublepage
\input{survey-Casolysis}
